...
const SOURCE_WALLET_ADDRESS: string = process.env.SOURCE_WALLET_ADDRESS || "YOUR_SOURCE_WALLET_ADDRESS";
const SOURCE_WALLET_BLOCKCHAIN = process.env.SOURCE_WALLET_BLOCKCHAIN || "ARC-TESTNET";
const DESTINATION_WALLET_ADDRESS: string = process.env.DESTINATION_WALLET_ADDRESS || "0xe45f8f8b39414578b871ed196edcba9d2822a432";
const DESTINATION_WALLET_ID: string = process.env.DESTINATION_WALLET_ID || "YOUR_DESTINATION_WALLET_ID";
const ARC_TESTNET_USDC: string = "0x3600000000000000000000000000000000000000";
const TRANSFER_AMOUNT_USDC: string = process.env.TRANSFER_AMOUNT_USDC || "5";
...
async function main() {
  ...
  if (
    ...
    console.warn("⚠️ Replace wallet constants or configure .env before executing live transfers.");
  }
